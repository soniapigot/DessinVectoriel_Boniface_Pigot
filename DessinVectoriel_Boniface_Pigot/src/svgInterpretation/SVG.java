	...
	public String TexteSVG(String nomDuDessin, IDessin dessin, Boolean b) {
		...
		try{
			writer = new FileWriter("fichierSVG/" + nomDuDessin + ".svg", true);
		     ...
		     //On parcourt toutes les etiquettes du dessin et on dessine le message avec le crayon utilisé
		     ...
		     //Si le dessin n'est pas un dessin inséré on a assigné la valeur true a b et on fini le dessin par la balise SVG
		     //Sinon c'est un dessin inséré et on ne termine pas le dessin par la balise SVG
		     if (b == true) {
