...
public class Builder {
	...
	public Builder () {
		...
		dessinBuilder.ajouterForme(formeBuilder2
				.ajouterChemin(cercleBuilder.choisirCentre(150,200).choisirDiametre(100).creerCercle())
				.ajouterCrayonContour(crayonBuilder2.choisirEpaisseur(1).choisirCouleur(Couleurs.pink).creerCrayon())
				.ajouterCrayonRemplir(crayonBuilder3.choisirEpaisseur(3).choisirCouleur(Couleurs.none).creerCrayon())
				.creerForme());
		...
		Crayon crayonContour = crayonBuilder.choisirCouleur(Couleurs.yellow).choisirEpaisseur(2).creerCrayon();
		Crayon crayonRemplir = crayonBuilder.choisirCouleur(Couleurs.pink).choisirEpaisseur(2).creerCrayon();
